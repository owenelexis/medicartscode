...
<section class="py-3">
    <div class="container">
        <div class="content px-3 py-5 bg-gradient-green">
                        ...
                        <div class="container-fluid">
                            ...
                            <form action="" id="order-form">
                                ...
                                <div class="py-1 text-center">
                                    <button class="btn btn-lg btn-deafault text-light bg-gradient-green col-lg-12 col-md-6 col-sm-12 col-xs-12 rectangle">Confirm Place Order / Cash on Delivery</button>
                                </div>
                            </form>
                            <form action="charge.php" method="post">
                                <input type="hidden" name="total_amount" value="<?= $cart_total ?>">
                                <input type="submit" name="submit" class="btn btn-lg btn-deafault text-light bg-gradient-green col-lg-12 col-md-6 col-sm-12 col-xs-12 rectangle mt-2" value="Confirm Place Order / Paypal">
                            </form>
                        </div>
                    </div>
                </div>
