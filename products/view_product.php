				...
				<div class="card rounded-0">
					...
					<div class="card-footer py-1 text-center">
						<?php if($_settings->userdata('id') != '' && $_settings->userdata('login_type') == 2): ?>
							<button class="btn btn-green btn-sm bg-gradient-green text-light rounded-0" type="button" id="add_to_cart"><i class="fa fa-cart-plus"></i> Add to Cart</button>
						<?php else: ?>
							<a class="btn btn-green btn-sm bg-gradient-green text-light rounded-0" href="./login.php" ><i class="fa fa-cart-plus"></i> Add to Cart</a>
						<?php endif; ?>
